...
|          Benchmark           | Phi-3-Vision | Mini-InternVL-4B-1-5 | InternVL2-4B |
| :--------------------------: | :----------: | :------------------: | :----------: |
|          Model Size          |     4.2B     |         4.2B         |     4.2B     |
|                              |              |                      |              |
|    DocVQA<sub>test</sub>     |      -       |         87.7         |     89.2     |
|    ChartQA<sub>test</sub>    |     81.4     |         81.0         |     81.5     |
|    InfoVQA<sub>test</sub>    |      -       |         64.6         |     67.0     |
|    TextVQA<sub>val</sub>     |     70.9     |         72.5         |     74.4     |
|           OCRBench           |     639      |         638          |     788      |
|      MME<sub>sum</sub>       |    1508.0    |        2053.6        |    2064.1    |
|         RealWorldQA          |     58.8     |         60.1         |     60.7     |
|     AI2D<sub>test</sub>      |     76.7     |         76.9         |     78.9     |
|      MMMU<sub>val</sub>      |     46.1     |         45.1         |     47.9     |
|  MMBench-EN<sub>test</sub>   |     73.6     |         76.2         |     78.6     |
|  MMBench-CN<sub>test</sub>   |      -       |         70.3         |     73.9     |
|    CCBench<sub>dev</sub>     |     24.1     |         58.8         |     66.5     |
|  MMVet<sub>GPT-4-0613</sub>  |      -       |         46.7         |     55.7     |
| MMVet<sub>GPT-4-Turbo</sub>  |     44.1     |         43.6         |     51.0     |
|          SEED-Image          |     70.9     |         72.5         |     73.7     |
|   HallBench<sub>avg</sub>    |     39.0     |         42.8         |     41.9     |
| MathVista<sub>testmini</sub> |     44.5     |         53.7         |     58.6     |
|  OpenCompass<sub>avg</sub>   |     53.6     |         56.2         |     60.6     |
...
```shell
lmdeploy serve api_server OpenGVLab/InternVL2-4B --server-port 23333
```
